...
mus_nodes = pd.read_csv('data/musician-graph/nodes.csv')
...
us_mus_nodes.to_csv('data/musician-graph/us_nodes.csv',index=False)
us_mus_edges.to_csv('data/musician-graph/us_edges.csv',index=False)
release_dat.to_csv('data/musician-graph/us-musician-release.csv',index=False)
